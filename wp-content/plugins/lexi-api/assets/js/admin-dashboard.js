            ...
            <div class="lexi-form">
                ...
                <div class="lexi-field">
                    ...
                    <select id="notif-target" style="width:100%;">
                        <option value="broadcast">بث للكل (الزبائن)</option>
                    ...
                    let formHtml = `
                        <div class="lexi-form">
                            ...
                            <div style="margin-top:30px; display:flex; gap:10px;">
                                <button class="button button-primary" onclick="saveFcmSettings()">حفظ الإعدادات</button>
            ...
            success: function (resp) {
                if (resp.success) {
                    resp.data.items.forEach(cat => {
                        categoriesHtml += `<option value="${cat.id}" ${item && item.term_id == cat.id ? 'selected' : ''}>${cat.name}</option>`;
                    });
                }
            }
        });
