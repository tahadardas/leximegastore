...
class Lexi_Merch
{
    ...
    public static function normalize_section_type(string $type): string
    {
        ...
        $allowed = array('manual_products', 'category', 'on_sale', 'newest', 'top_rated', 'flash_deals');
    ...
    public static function resolve_products_for_section(array $section, int $limit = 12, bool $exclude_unpriced = true): array
    {
        ...
        if ('newest' === $type) {
            ...
            $query_args['order'] = 'DESC';
        } elseif (in_array($type, array('on_sale', 'flash_deals'), true)) {
    ...
    /**
     * Get products with active flash deals (using meta _lexi_flash_deal_active).
     *
     * @return array<int, array<string, mixed>>
     */
    public static function get_flash_deals(): array
    {
        $args = array(
            'post_type' => 'product',
            'post_status' => 'publish',
